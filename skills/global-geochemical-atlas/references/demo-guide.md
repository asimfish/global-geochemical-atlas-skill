...
预期为 688 条真实来源最小观测、四介质、十三来源、688/688 标准化和有效坐标、20 条已确认删失值、85 个隔离背景组及完整九文件输出。FOREGS 中可能的 `DL/2` 数值只带证据警告，不冒充已确认删失。演示时先展示覆盖空白和来源范围，再展示地图；11 个候选异常只用于说明筛查界面，不能作污染、矿化或区域元素丰亏结论。
