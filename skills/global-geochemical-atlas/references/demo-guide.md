...
4. 打开地图，先展示全部元素的样品级介质分类总览，再筛选 As/soil；方法组收敛后地图自动切换为浓度对数色阶。
5. 点击 500 mg/kg 候选点，核对原值、标准值、方法、QC、置信度和来源定位。
6. 切换“来源与置信度”“异常结果”“质量与边界”，展示证据等级、背景组、样本量、MAD、坐标空洞和解释边界。
7. 展示水体 ppm、坐标交换与小样本组的失败关闭。
