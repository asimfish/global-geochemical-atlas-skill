...
- `soil`：状态 `partial`；来源 afsis-phase-i-wet-chemistry、eidc-ningbo-soil、foregs-humus、foregs-subsoil、foregs-topsoil、gemas-europe、pangaea-amazonas-soil、pangaea-barents-c-horizon-soil、pangaea-batagay-soil、pangaea-north-africa-soil、tpdc-china-mountain-soil、usgs-conus-soil；注册目标覆盖本次元素；仍需记录级核验；来源独立性 `multiple_independent_lineages`。
