...
2b. **参考边界**:国界(Natural Earth 1:110m Admin-0)常显细线;区域研究命中固定 Admin-1 资产(当前为中国省界 1:50m)时叠加虚线省界。边界环预计算包围盒、按视口剔除,脚注披露资产版本与「仅供定位示意」语义。区域研究的视野钳制在冻结区域附近(平移边界 = 区域外扩 35%,最小缩放 = 区域适配值),区域内允许最大 120 倍深放大;全球研究保持原 0.85–45 范围。
