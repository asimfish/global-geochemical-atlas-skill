...
D2_REFERENCE_ROOT = REPO_ROOT / "evaluation_lyf" / "reference_implementation" / "d2"
D2_SCRIPT = D2_REFERENCE_ROOT / "scripts" / "geochem_d2_pipeline.py"
D2_FIXTURE = D2_REFERENCE_ROOT / "fixtures" / "demo_input.csv"
D2_SCHEMA = D2_REFERENCE_ROOT / "schema.json"
D2_MANIFEST_SCHEMA = D2_REFERENCE_ROOT / "contracts" / "run-manifest.schema.json"
