...
```text
evaluation_lyf/stage_benchmark/runs/expanded-latest/d1/d1_global_export.csv
evaluation_lyf/stage_benchmark/runs/expanded-latest/d1/d1_global_manifest.json
```

### D3 的冻结输入（D2 已处理）

```text
evaluation_lyf/stage_benchmark/runs/expanded-latest/d2
evaluation_lyf/stage_benchmark/runs/expanded-latest/d1/d1_global_manifest.json
```
...
```text
evaluation_lyf/stage_benchmark/runs/expanded-latest/d3
```
