...
状态：`d2-interface-v2`，只供 `evaluation_lyf` 基准自校验和候选模块对照，不是团队正式 D2 实现。
...
```text
evaluation_lyf/reference_implementation/d2/
├── README.md
├── HANDOFF.md
├── contracts/
...
python3 evaluation_lyf/reference_implementation/d2/scripts/geochem_d2_pipeline.py \
  --input evaluation_lyf/reference_implementation/d2/fixtures/demo_mapped_input.csv \
  --schema-map evaluation_lyf/reference_implementation/d2/fixtures/demo_schema_map.json \
...
```bash
python3 evaluation_lyf/reference_implementation/d2/scripts/geochem_d2_pipeline.py \
  --input evaluation_lyf/reference_implementation/d2/fixtures/demo_input.csv \
...
python3 evaluation_lyf/reference_implementation/d2/scripts/geochem_d2_pipeline.py \
  --input evaluation_lyf/reference_implementation/d2/fixtures/demo_input.csv \
  --output-dir evaluation_lyf/reference_implementation/d2/demo_output \
  --min-group-size 8
```
...
- `geology_report.json`：版本化空间地质连接的适用性、匹配率、图层哈希和失败处置。
...
```bash
python3 evaluation_lyf/reference_implementation/d2/scripts/geochem_d2_pipeline.py --help
```
